            ...
            <div class="col-md-12">
                ...
                <div class="main_menu">
                    <ul id="nav_menu" class="active_cl">
                        ...
                        <li><a href="shop.html"><span class="Clothings">Shop</span></a>
                            <div class="mega_menu_list">
                                <div class="single_megamenu">
                                    <h2><a href="shop.html">Learning</a></h2>
                                ...
                                <div class="single_megamenu">
                                    <h2><a href="shop.html">Lighting</a></h2>
                                    <div class="items_list">
                                        <a href="shop.html"><i class="fa fa-angle-right"></i>Carnation</a>
                                        <a href="shop.html"><i class="fa fa-angle-right"></i>Daisy</a>
                                        <a href="shop.html"><i class="fa fa-angle-right"></i>Rose</a>
                                ...
                                <div class="single_megamenu">
                                    <h2><a href="shop.html">Living Room</a></h2>
                                    <div class="items_list">
                                        <a href="shop.html"><i class="fa fa-angle-right"></i>Carnation</a>
                                        <a href="shop.html"><i class="fa fa-angle-right"></i>Daisy</a>
                                        <a href="shop.html"><i class="fa fa-angle-right"></i>Rose</a>
                        ...
                        <li><a href="shop.html"><span class="Lookbook">Lookbook</span></a>
                            <div class="look_mega_menu">
                                <div class="look_single">
                                    <h3>Rose</h3>
                                    <div class="items_list_lk">
                                        <a href="shop.html"><i class="fa fa-angle-right"></i>Yellow Rose</a>
                                        <a href="shop.html"><i class="fa fa-angle-right"></i>White Rose</a>
                                    </div>
                                </div>
                                <div class="look_single">
                                    <h3>Orchids</h3>
                                    <div class="items_list_lk">
                                        <a href="shop.html"><i class="fa fa-angle-right"></i>Orchids Samurai</a>
                                        <a href="shop.html"><i class="fa fa-angle-right"></i>Orchids Phalaenopsis</a>
                                    </div>
                                </div>
                                <div class="look_single">
                                    <h3>Chrysanthemum</h3>
                                    <div class="items_list_lk">
                                        <a href="shop.html"><i class="fa fa-angle-right"></i>Red Chrysanthemum</a>
                                        <a href="shop.html"><i class="fa fa-angle-right"></i> Yellow Chrysanthemum</a>
                                    </div>
                                </div>
                        ...
                        <li><a href="blog-right-sidebar.html"><span class="Footwear">Blog</span></a>
                            <div class="home_mega_menu">
                        ...
                        <li><a href="shop.html"><span class="Sales">Clothing</span></a>
                        </li>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="single_image">
                    <a href="#"><img class="banner_home1" src="{{asset('img/collection-image/banner-1.jpg')}}" alt="" /></a>
                    <div class="banner_text">
                        <h2><a href="#">Birthday Bouguets</a></h2>
                    </div>
                    <div class="shop_collection">
                        <a href="shop.html">Shop the Collection <span><img src="{{asset('img/arrow/bkg_newsletter.png')}}" alt="" /></span></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="single_image">
                    <a href="#"><img class="banner_home1" src="{{asset('img/collection-image/banner-2.jpg')}}" alt="" /></a>
                    <div class="banner_text">
...
<div class="banner_area">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="single_image">
                    <a href="#"><img class="banner_home1" src="{{asset('img/collection-image/banner-11.jpg')}}" alt="" /></a>
                    <div class="banner_text">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="single_image">
                    <a href="#"><img class="banner_home1" src="{{asset('img/collection-image/banner-12.jpg')}}" alt="" /></a>
                    <div class="banner_text">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="single_image">
                    <a href="#"><img class="banner_home1" src="{{asset('img/collection-image/banner-13.jpg')}}" alt="" /></a>
                    <div class="banner_text">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="product_list">
                    <div class="single_product">
                        <a href="product.html" target="main"><img src="{{asset('img/product/pr1.png')}}" alt="" /></a>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="product_list">
                    <div class="single_product">
                        <a href="product.html" target="main"><img src="{{asset('img/product/pr2.png')}}" alt="" /></a>
                        <div class="product_details">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="product_list">
                    <div class="single_product">
                        <a href="product.html" target="main"><img src="{{asset('img/product/pr3.png')}}" alt="" /></a>
                        <div class="product_details">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="product_list">
                    <div class="single_product">
                        <a href="product.html" target="main"><img src="{{asset('img/product/pr4.png')}}" alt="" /></a>
                        <div class="product_details">
        ...
        <div class="row">
            <div class="product_bottom_area">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="product_list">
                        <div class="single_product">
                            <a href="product.html" target="main"><img src="{{asset('img/product/pr5.png')}}" alt="" /></a>
                            <div class="product_details">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="product_list">
                        <div class="single_product">
                            <a href="product.html" target="main"><img src="{{asset('img/product/pr6.png')}}" alt="" /></a>
                            <div class="product_details">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="product_list">
                        <div class="single_product">
                            <a href="product.html" target="main"><img src="{{asset('img/product/pr7.png')}}" alt="" /></a>
                            <div class="product_details">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="product_list">
                        <div class="single_product">
                            <a href="product.html" target="main"><img src="{{asset('img/product/pr8.png')}}" alt="" /></a>
                            <div class="product_details">
        ...
        <div class="row">
            <div class="product_bottom_area">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="product_list">
                        <div class="single_product">
                            <a href="product.html" target="main"><img src="{{asset('img/product/pr9.png')}}" alt="" /></a>
                            <div class="product_details">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="product_list">
                        <div class="single_product">
                            <a href="product.html" target="main"><img src="{{asset('img/product/pr10.png')}}" alt="" /></a>
                            <div class="product_details">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="product_list">
                        <div class="single_product">
                            <a href="product.html" target="main"><img src="{{asset('img/product/pr11.png')}}" alt="" /></a>
                            <div class="product_details">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="product_list">
                        <div class="single_product">
                            <a href="product.html" target="main"><img src="{{asset('img/product/pr12.png')}}" alt="" /></a>
                            <div class="product_details">
            ...
            <div class="col-lg-12">
                <div class="testimonial_list">
                    <div class="testimonial_single">
                        ...
                        <p>alexmax</p>
                        <div class="author">
                            <img src="{{asset('img/author/avatar.png')}}" alt="" />
                        </div>
                    </div>
                    <div class="testimonial_single">
                        <a href="#">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.</a>
            ...
            <div class="carousel_blog_list">
                <div class="col-lg-3">
                    <div class="single_blog">
                        <a href="#"><img src="{{asset('img/blog-post-image/cl-1.jpg')}}" alt="" /></a>
                ...
                <div class="col-lg-3">
                    <div class="single_blog">
                        <a href="#"><img src="{{asset('img/blog-post-image/cl-2.jpg')}}" alt="" /></a>
                        <div class="blog_details">
                ...
                <div class="col-lg-3">
                    <div class="single_blog">
                        <a href="#"><img src="{{asset('img/blog-post-image/cl-3.jpg')}}" alt="" /></a>
                        <div class="blog_details">
                ...
                <div class="col-lg-3">
                    <div class="single_blog">
                        <a href="#"><img src="{{asset('img/blog-post-image/cl-4.jpg')}}" alt="" /></a>
                        <div class="blog_details">
